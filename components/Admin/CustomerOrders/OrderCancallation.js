...
function OrderCancellation({ isOpen, setIsOpen, order }) {
    ...
    <div className="fixed flex justify-center items-center top-0 left-0 w-full h-full bg-black bg-opacity-60 z-50">
      <div className="bg-white w-[40%] rounded-sm p-4">
        ...
        <div className="text-center mb-4">
          ...
          <p>
            <strong>Total Değer:</strong> {order.total} TL
          </p>
        </div>
        ...
        <form>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              id="message"
              rows="4"
              placeholder="Siparişi iptal etme nedeninizi buraya yazın"
            ></textarea>
          </div>
