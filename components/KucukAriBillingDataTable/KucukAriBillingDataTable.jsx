...
import KucukAriExpandedTable from "./ExpandedTable";
...
export default function KucukAriBillingDataTable() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      setDetailedData(
        enhancedDetailedData.filter((item) => {
          // console.log(
          //   "FATHARCARKOD:",
          //   item.FATHARCARKOD,
          //   "edisCarkod:",
    ...
    <div className="print-section min-h-screen pt-4 bg-[#dbdbdb]">
      ...
      <div className="max-w-[80%] mx-auto flex flex-col justify-between bg-white rounded-xl border-2 border-dashed border-[#1e3b606e] items-center px-8 gap-4 md:flex-row p-4">
        <div className="flex flex-col w-full md:w-auto">
          <div>
            <h1 className="text-xl lg:text-2xl text-blue-600">
              EDIS Cari Bilgisi
            </h1>
          </div>
